    ...
    void Settings::Load()
    {
        ...
        if (!std::filesystem::exists(_path)) {
            _values = json::json::object({
                ...
                { "chaos.super_jump.price", "150" },
                { "chaos.super_jump.duration_seconds", "20" },
                { "chaos.ragdoll_blast.price", "200" },
                { "chaos.tiny_dovahkiin.price", "150" },
                { "chaos.giant_dovahkiin.price", "200" },
                { "chaos.scale_effect.duration_seconds", "20" },
                { "chaos.drunk_vision.price", "120" },
                { "chaos.wild_magic.price", "250" },
                { "chaos.midas_weight.price", "180" },
                { "chaos.pocket_change_blast.price", "100" },
